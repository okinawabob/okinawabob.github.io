...
//        parent.frames("fraAttack").document.images[Attackers-2].src = SoldierRed[2].src;
     ...
     Timer1 = window.setTimeout("DetermineWinner(DefRolls, AtkRolls)", Timer);
  }
}

function DetermineWinner(DefRolls, AtkRolls)
{
